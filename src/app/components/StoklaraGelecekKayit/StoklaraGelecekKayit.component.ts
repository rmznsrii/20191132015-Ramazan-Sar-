...
@Component({
  selector: 'app-StoklaraGelecekKayit',
  templateUrl: './StoklaraGelecekKayit.component.html',
  styleUrls: ['./StoklaraGelecekKayit.component.css']
})
export class StoklaraGelecekKayitComponent implements OnInit {
  kayitlar: any;
